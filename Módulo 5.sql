...
SELECT DISTINCT
	...
	EmployeeCount AS 'NRM FUNCIONARIO'
FROM
	DimStore
...
SELECT 
	COUNT (DISTINCT	(StoreName)) AS 'QTDE ATIVAS'
FROM
	DimStore
WHERE 
	Status='ON'
...
FROM 
	DimProduct
WHERE 
	AvailableForSaleDate='20090315' and BrandName='Litware' and ProductName LIKE '%Home Theater%'
